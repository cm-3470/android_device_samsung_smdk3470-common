...
void select_devices(struct audio_device *adev)
{
    ...
    if (adev->out_device == AUDIO_DEVICE_OUT_BLUETOOTH_SCO_HEADSET) 
    {
            adev->in_device = AUDIO_DEVICE_IN_BLUETOOTH_SCO_HEADSET & ~AUDIO_DEVICE_BIT_IN;
    }
...
static int start_call(struct audio_device *adev)
{
    ...
    bt_on = true;//adev->out_device & AUDIO_DEVICE_OUT_ALL_SCO;
