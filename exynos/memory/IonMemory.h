...
#ifndef ANDROID_HIDL_ION_MEMORY_V1_0_MEMORY_H
#define ANDROID_HIDL_ION_MEMORY_V1_0_MEMORY_H
...
struct IonMemory : public IMemory {

    IonMemory(const hidl_memory& memory, void* mappedMemory);
    ~IonMemory();
...
#endif  // ANDROID_HIDL_ION_MEMORY_V1_0_MEMORY_H
